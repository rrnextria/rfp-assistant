...
const NAV_LINKS = [
  {
    href: "/ask",
    label: "Ask AI",
    description: "Query your product knowledge base",
    icon: "💬",
  },
  {
    href: "/rfps",
    label: "RFPs",
    description: "Manage and respond to RFPs",
    icon: "📋",
  },
];
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <nav className="flex items-center gap-1">
            ...
            <div className="relative group">
              <button className="flex items-center gap-1.5 rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors">
                <span>⚙️</span>
                Admin
              </button>
